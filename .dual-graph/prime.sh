#!/usr/bin/env bash
PORT=$(cat "/home/oruc/Dokumente/Akademie/medical Copilot/Oruc93.github.io/.dual-graph/mcp_port" 2>/dev/null || echo 8080)
...
if [[ -f "/home/oruc/Dokumente/Akademie/medical Copilot/Oruc93.github.io/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/home/oruc/Dokumente/Akademie/medical Copilot/Oruc93.github.io/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject context store entries (decisions, tasks, next steps) — max 15 lines, 7-day window
STORE="/home/oruc/Dokumente/Akademie/medical Copilot/Oruc93.github.io/.dual-graph/context-store.json"
